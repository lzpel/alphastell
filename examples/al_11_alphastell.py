...
def make_stellarator(
	...
	# aries-cs 2006 https://fti.neep.wisc.edu/fti.neep.wisc.edu/aries-cs/builds/build092606.pdf
	radial_build: List[Tuple[str, List[List[float]]]] = [  # 層名と厚さ行列 [m]。行がトロイダル 1 周期、列がポロイダル 1 周。al_10 の parastell_cad_to_dagmc_example と同じ値
		...
		("first_wall", [[0.038]]),
		("breeder", [  # Non-uniform Blanket 25 - 54.3 cm。2006-09-26 Final Radial Build p.8 Compositions and Coverage Fractions より
			[0.543, 0.543, 0.543, 0.250, 0.250, 0.250, 0.543, 0.543, 0.543],
			[0.543, 0.543, 0.543, 0.250, 0.250, 0.543, 0.543, 0.543, 0.543],
			[0.543, 0.543, 0.250, 0.250, 0.543, 0.543, 0.543, 0.543, 0.543],
			[0.484, 0.250, 0.250, 0.484, 0.543, 0.543, 0.543, 0.543, 0.484],
			[0.367, 0.367, 0.543, 0.543, 0.543, 0.543, 0.543, 0.367, 0.367],
			[0.484, 0.543, 0.543, 0.543, 0.543, 0.484, 0.250, 0.250, 0.484],
			[0.543, 0.543, 0.543, 0.543, 0.543, 0.250, 0.250, 0.543, 0.543],
			[0.543, 0.543, 0.543, 0.543, 0.250, 0.250, 0.543, 0.543, 0.543],
			[0.543, 0.543, 0.543, 0.250, 0.250, 0.250, 0.543, 0.543, 0.543],
		]),
		("back_wall", [[0.05]]),
		("shield", [  # 増殖層と逆位相。Δmin では FS-Shield-I 14 + WC 34 = 48 cm、全厚部は FS 32 cm だけ
			[0.320, 0.320, 0.320, 0.480, 0.480, 0.480, 0.320, 0.320, 0.320],
			[0.320, 0.320, 0.320, 0.480, 0.480, 0.320, 0.320, 0.320, 0.320],
			[0.320, 0.320, 0.480, 0.480, 0.320, 0.320, 0.320, 0.320, 0.320],
			[0.352, 0.480, 0.480, 0.352, 0.320, 0.320, 0.320, 0.320, 0.352],
			[0.416, 0.416, 0.320, 0.320, 0.320, 0.320, 0.320, 0.416, 0.416],
			[0.352, 0.320, 0.320, 0.320, 0.320, 0.352, 0.480, 0.480, 0.352],
			[0.320, 0.320, 0.320, 0.320, 0.320, 0.480, 0.480, 0.320, 0.320],
			[0.320, 0.320, 0.320, 0.320, 0.480, 0.480, 0.320, 0.320, 0.320],
			[0.320, 0.320, 0.320, 0.480, 0.480, 0.480, 0.320, 0.320, 0.320],
		]),
		("vacuum_vessel", [[0.28]]),
	],
